...
var user_configuration={
	...
	initial_size:"16px", //initial size of the stars
	...
	fade_duration:"1.2s", //how long the star fades for
	...
	frequency:5000, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
...
Star.prototype.create=function(parent_element,id){
	...
	var star=$(`
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffa534">
	...
	if(user_configuration.custom_svg==='' || user_configuration.custom_svg===false){
		star.css('color',user_configuration.colors[Math.floor(Math.random()*user_configuration.colors.length)]); //picks one of the colors
	}
